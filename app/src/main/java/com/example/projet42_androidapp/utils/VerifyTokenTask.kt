...
class VerifyTokenTask(
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        return try {
            ...
            val jwkSetURL = URL("http://172.20.10.4:8090/realms/projet42-realm/protocol/openid-connect/certs")
    ...
    private fun validateClaims(claimsSet: JWTClaimsSet): Boolean {
        ...
        return issuer == "http://172.20.10.4:8090/realms/projet42-realm" && audience.contains("projet42-api")
    }
}
